<template>
  <div class="max-w-screen-xl mx-auto px-4 py-8 sm:p-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 border p-4 shadow-lg rounded-lg gap-6">
      ...
      <div class="rounded overflow-hidden shadow-lg flex flex-col">
        ...
        <div class="px-6 py-4 mb-auto">
          <a href="#"
            class="font-bold text-lg hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-1">Hambúrger
            da Médio</a>
          <p class="text-gray-700 text-sm">
            Delicie-se com o <span class="font-semibold">Hambúrger Médio:</span> Pão da casa, molho especial, salada,
            queijo muçarela, fiâmbre, ovo e carne deliciosa.
          </p>
        </div>
        <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
          <span class="font-bold text-lg">3.000kz</span>
      ...
      <div class="rounded overflow-hidden shadow-lg flex flex-col">
        ...
        <div class="px-6 py-4 mb-auto">
          <a href="#"
            class="font-bold text-lg hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-1">Big
            Hambúrger</a>
          <p class="text-gray-700 text-sm">
            Delicie-se com o <span class="font-semibold">Hambúrger Big:</span> Pão da casa, molho especial, salada,
            queijo muçarela, fiâmbre, ovo Gasosa-x1 e carne deliciosa-x2.
          </p>
        </div>
        <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
